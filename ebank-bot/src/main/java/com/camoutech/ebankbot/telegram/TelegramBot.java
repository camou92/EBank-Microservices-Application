package com.camoutech.ebankbot.telegram;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    public TelegramBot(
            EbankAIAgent aiAgent,
            @Value("${telegram.token}") String token  // ← injecter via constructeur
    ) {
        super(token);  // ← passer au parent ici
